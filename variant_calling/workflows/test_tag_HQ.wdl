...
workflow test_tag_HQ {
    ...
    call tag_HQ {
        input:
            ...
            agreeing_gv_threshold = agreeing_gv_threshold,
            disagreeing_gv_threshold = disagreeing_gv_threshold,
            unphased_threshold = unphased_threshold,
    ...
    output {
        File output_vcf = tag_HQ.output_vcf
        File output_vcf_idx = tag_HQ.output_vcf_idx
    }
}
